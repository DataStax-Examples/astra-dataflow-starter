...
public class Gcs_To_AstraDb {
  ...
  public static void main(String[] args) throws IOException {
    ...
    String astraToken = AstraIOGcpUtils.readTokenSecret(astraOptions.getAstraToken());
    byte[] astraSecureBundle = AstraIOGcpUtils.readSecureBundleSecret(astraOptions.getSecureConnectBundle());
